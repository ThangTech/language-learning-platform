...
const FOOTER_LINKS = {
  ...
  progress: [
    ...
    { label: 'Chuỗi học tập', href: '/streaks' },
      ...
      <div className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="font-body text-sm text-on-surface-variant max-w-[220px]">
            Nền tảng luyện nghe theo lộ trình VSTEPS, tập trung vào bài học thực tế và tiến bộ rõ ràng.
          </p>
        </div>

        <div>
          <h4 className="font-headline text-sm font-bold text-on-surface mb-4">Lộ trình học</h4>
